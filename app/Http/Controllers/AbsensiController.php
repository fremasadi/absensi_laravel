<div>
    ...
    <div id="selfie-upload-section" style="display: none;">
        ...
        <form id="selfie-upload-form">
            ...
            <input type="hidden" name="selfie_type" id="selfie-type">
                ...
                fetch('/handle-scan', {
                  ...
                  .then(data => {
                      ...
                      if (data.absensi_id) {
                          ...
                          // Set jenis selfie (masuk atau keluar) berdasarkan respons dari server
                          document.getElementById('selfie-type').value = data.selfie_type || 'masuk';
            ...
            function captureSelfie() {
                ...
                if (video.readyState === video.HAVE_ENOUGH_DATA) {
                    ...
                    canvas.toBlob(function(blob) {
                        ...
                        formData.append('selfie_type', document.getElementById('selfie-type').value);
